  ...
  const products = [
    {
      category: "Food",
      image: imgg1,
      name: "Organic Delicious Pomegranate",
      price: 53.56,
    },
    {
      category: "Fish",
    ...
    },
    {
      category: "Food",
      image: imgg3,
      name: "Organic Delicious Cutting Pear",
      price: 53.56,
    },
    {
      category: "Vegetable",
      image: imgg9,
      name: "Organic Delicious Fresh Tomato",
      price: 53.56,
    },
    {
      category: "Vegetable",
    ...
    <div className="container py-5">
      ...
      <div className="row">
        {products.map((product, index) => (
          <div key={index} className="row col-md-3 col-lg-3 mb-1 text-center ">
            {" "}
            {/* Each card gets a column */}
